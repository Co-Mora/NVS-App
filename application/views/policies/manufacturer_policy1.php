            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo base_url()?>create_manufacturer_policy1" class="btn btn-info pull-right">Add Policy</a>
                    </div>
                    <!-- /.box-header -->
                    ...
                    <div class="box-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach ($get_manufacturer1 as $item):?>
                                <tr>
                                    ...
                                    <td><a href='<?php echo base_url();?>Policies/update_manufacturer_policy1/<?php echo $item->id?>' class='label label-success'>Update</a></td>
                                    <td><a href='<?php echo base_url();?>Policies/delete_manufacturer_policy1/<?php echo $item->id?>' class='label label-danger'>Delete</a></td>
